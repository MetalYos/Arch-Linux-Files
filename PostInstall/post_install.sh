...
function InstallAdditionalPackages() {
	...
	pacman -S iw wpa_supplicant dialog intel-ucode lshw unzip htop wget pulseaudio alsa-utils alsa-plugins pavucontrol neovim openssh git gdb valgrind man tmux --noconfirm
}
