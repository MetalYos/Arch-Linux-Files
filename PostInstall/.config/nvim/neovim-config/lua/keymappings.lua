...
-- window movement
vim.api.nvim_set_keymap('', '<C-w>h', '<C-w>h', opts)
vim.api.nvim_set_keymap('', '<C-w>j', '<C-w>j', opts)
vim.api.nvim_set_keymap('', '<C-w>k', '<C-w>k', opts)
vim.api.nvim_set_keymap('', '<C-w>l', '<C-w>l', opts)
